...
1.87	- Added additional abilities to the Mad Vasari Vorastra Titan. A word of advice - Don't let it bomb out your planets. :)
		...
		- Added a special mission map "The Terror". How long can you survive against an onslaught of Mad Vasari forces?
		...
		- Advent Evangelization Nodes Starbase Upgrade culture spread rate reduced by ~30%.
		...
		- TEC Gauss research upgrades now also improve the Ragnarov's "Railgun" weapon type.
		- Doubled the increased damage from each TEC Beam Weapon research from 5% to 10% (max now 40%).
		- Advent culture research upgrades now also improve "Psionic Surge" weapons (max 30%).
		- Advent Titan "Point Defense" weapons change to Laser so that they will benefit from research upgrades.
		- Kultorask Titan "Point Defense" weapon changed to Flash Beam so that it will benefit from research upgrades.
...
1.88	-Pact Rework
		...
		-Sova's Heavy Fighters ability buffed to increase damage by 33/44/55/66%, armor buffed to 6/9/12/15. This brings it in line with the Halcyon's extra squads in terms of total stats added.
		-Sova's Rapid Manufacturing now applies instant fighter rebuild to all TEC units with strikecraft for a brief time.
		...
		-Increased Hoshiko's Demolition Bots ability cooldown from 3 to 15.
		-Antimodule Cruisers durability increased by roughly 50%, speed reduced from 450 to 400.
...
1.881	-Advent Culture research now gives half the shield mitigation bonus, but now receives 10% shield regeneration in culture per level (3% mitigation, 60% shield regen bonus total).
		-Reduced Vasari Central Command innate salvaging bonus from 15% to 10%.
...
1.882	-Reduced Advent Embassy HP/Shield to 600/600 as it was far tankier than other embassies due to shield mitigation.
		-Added new "Major Shipyard" planet bonus. Can be found on Industrial, Igneous, Hydrocarbon, Ferrous, and Volcanic planets, and is available to map makers.
		-Added planet bonuses added by E4X to the Ferrous and Greenhouse planet bonus list.
		...
		-Doubled the regeneration rate of all scouts to help them survive longer.
		-Advent Beam Turret's Synergy ability nerfed. Requires 10 stacks instead of 4 to reach the max additional shield/damage.
