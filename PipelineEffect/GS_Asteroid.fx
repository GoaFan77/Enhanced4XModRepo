...
{ 
	...
	#ifndef IsDebug	
		finalColor += lightSideSample * GetLightColor(dotLight, 0.8f, .17f, 0.8f, g_Light0_DiffuseLite, g_Light0_DiffuseDark);
		finalColor += lightSideSample * GetLightColor(-dotLight, 0.8f, .1f, 0.f, g_Light_AmbientLite, g_Light_AmbientDark);
	...
	#else	
		finalColor += lightSideSample * GetLightColor(dotLight, 0.8f, .17f, 0.8f, g_Light0_DiffuseLite, g_Light0_DiffuseDark) * DiffuseScalar;
		finalColor += lightSideSample * GetLightColor(-dotLight, 0.8f, .1f, 0.f, g_Light_AmbientLite, g_Light_AmbientDark) * AmbientScalar;
